    ...
    <footer className='bg-[#333] p-10'>
        ...
        <div className='flex items-center justify-between flex-col md:flex-row w-full '>
            ...
            <div className='w-full p-5'>
                <h2 className='text-2xl'><Link href="/">pictopod</Link></h2>
                <p className='text-gray-500'>An app for your visual needs and desires</p>
            </div>


            <div className='flex flex-col gap-4 items-center p-4 bg-[#222]'>
                <Link href="/gallary" className='bg-[#444] p-2 hover:bg-[#111]'>Gallary</Link>
